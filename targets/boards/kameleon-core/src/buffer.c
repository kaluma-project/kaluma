...
void FillRingBuffer(ringbuffer_t * pRingBuffer, uint8_t * pbuf, uint32_t len) {
	uint32_t k;
	uint32_t w_ptr;
...
void ReadRingBuffer(ringbuffer_t * pRingBuffer, uint8_t *pbuf, uint32_t len) {
	uint32_t k;
	uint32_t r_ptr;
...
uint32_t GetDataLenInRingBuffer(ringbuffer_t * pRingBuffer) {
	uint32_t len;
...
void FlushRingBuffer(ringbuffer_t *pRingBuffer, uint32_t len) {       
	uint32_t r_ptr;
...
void InitRingBuffer(ringbuffer_t * pRingBuffer, uint8_t * pbuf, uint32_t len) {
	pRingBuffer->r_ptr = 0;
	pRingBuffer->w_ptr = 0;
