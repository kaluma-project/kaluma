...
var uart = require('uart'); var serial0 = uart.open(0, { baudrate: 9600, dataEvent: '\n' }); serial0.on('data', function (data) { var line = String.fromCharCode.apply(null, new Uint8Array(data)); console.log(line); });
